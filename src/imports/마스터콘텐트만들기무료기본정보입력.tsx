import svgPaths from "./svg-u8upu5aguj";
...
function Component1({ className }: { className?: string }) {
  return (
    <div className={className} data-name="마스터 콘텐트 만들기_무료_기본정보 입력">
      ...
      <div className="bg-white content-stretch flex flex-col gap-[15px] items-start overflow-clip pl-[30px] pr-[20px] py-[20px] relative shrink-0 w-[430px]">
        ...
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
          <Component className="[grid-area:1_/_1] ml-0 mt-0 relative size-[20px]" />
          <div className="[grid-area:1_/_1] ml-[81px] mt-0 relative size-[20px]" data-name="라디오 버튼">
        ...
        <div className="h-[40px] relative rounded-[8px] shrink-0 w-[370px]">
          <div className="h-[40px] overflow-clip relative rounded-[inherit] w-[370px]">
            <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[normal] left-[18px] not-italic text-[#a8a8a8] text-[14px] text-nowrap top-[12px] whitespace-pre">콘텐츠 제목</p>
          </div>
        ...
        <div className="h-[100px] relative rounded-[8px] shrink-0 w-[370px]">
          <div className="h-[100px] overflow-clip relative rounded-[inherit] w-[370px]">
            <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[normal] left-[18px] not-italic text-[#a8a8a8] text-[14px] text-nowrap top-[12px] whitespace-pre">콘텐츠 소개글</p>
          </div>
          <div aria-hidden="true" className="absolute border border-[#dddddd] border-solid inset-0 pointer-events-none rounded-[8px]" />
        </div>
      </div>
      <div className="bg-white h-[501px] relative shrink-0">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col h-[501px] items-start pb-[1548px] pt-[20px] px-[35px] relative">
