import svgPaths from "./svg-pff8h47t8z";
...
function Icons({ children }: React.PropsWithChildren<{}>) {
  return (
...
function BirthdateContainer() {
  return (
    <div className="content-stretch flex items-center relative rounded-[12px] shrink-0 w-full" data-name="Birthdate Container">
      <p className="font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[16px] overflow-ellipsis overflow-hidden relative shrink-0 text-[#848484] text-[12px] text-nowrap tracking-[-0.24px]">양력 1994.07.23 午(오)시</p>
    </div>
  );
}
