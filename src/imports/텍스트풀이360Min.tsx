import svgPaths from "./svg-7tmsq9tf93";
      ...
      <div className="basis-0 grow h-0 min-h-px min-w-px relative shrink-0" data-name="Divider">
        <div className="absolute inset-[-0.5px_0]" style={{ "--stroke-0": "rgba(231, 231, 231, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 246 1">
            <path d="M246 0.5H0" id="Divider" stroke="var(--stroke-0, #E7E7E7)" />
          </svg>
        </div>
      </div>
    </div>
...
function CardInterpretationCard() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 top-[112px] translate-x-[-50%] w-[320px]" data-name="Card / Interpretation Card">
      <Container1 />
    </div>
  );
}
...
function TopNavigationContainer() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 top-0 translate-x-[-50%] w-[360px]" data-name="Top Navigation Container">
...
export default function Component360Min() {
  return (
    <div className="bg-white relative size-full" data-name="텍스트 풀이 _ 360 (Min)">
