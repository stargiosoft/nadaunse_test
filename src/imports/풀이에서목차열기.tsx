import svgPaths from "./svg-lc423pfjr1";
...
function ButtonContentsButton5({ children }: React.PropsWithChildren<{}>) {
  return (
...
function Container15() {
  return (
    <div className="basis-0 grow min-h-px min-w-px mr-[-11px] relative shrink-0" data-name="Container">
      <div className="size-full">
...
function List() {
  return (
    <div className="bg-white content-stretch flex items-start pl-0 pr-[11px] py-0 relative shrink-0 w-full" data-name="List">
      <Container15 />
...
function BottomSheetContentsBottomSheetWidget() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col items-start left-1/2 translate-x-[-50%] w-[390px]" data-name="Bottom Sheet/Contents Bottom Sheet (Widget)">
      <ContentContainer />
      <CommonBottomButton />
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="풀이에서 목차 열기">
