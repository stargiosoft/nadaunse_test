import svgPaths from "./svg-pihtehivvs";
...
function FormInput() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[20px] top-[115px] w-[354px]" data-name="Form / Input">
      <LabelContainer />
      <InputContainer />
    </div>
  );
...
function FormInput1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[20px] top-[347px] w-[354px]" data-name="Form / Input">
      <LabelContainer1 />
      <InputContainer1 />
    </div>
  );
...
function OptionContainer() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-start justify-end left-[20px] top-[459px] w-[354px]" data-name="Option Container">
      <FormInput2 />
      <ButtonContainer1 />
    </div>
  );
...
function FormSelectField() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[20px] top-[563px] w-[354px]" data-name="Form / Select Field">
      <SelectField />
    </div>
  );
}
...
function FormInput3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[20px] top-[675px] w-[350px]" data-name="Form / Input">
      <LabelContainer5 />
      <InputContainer4 />
    </div>
  );
