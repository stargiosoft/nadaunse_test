import svgPaths from "./svg-n2qe7d8u26";
...
function Text1({ text }: Text1Props) {
  return (
    <ul className="block font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#999] text-[16px] text-nowrap tracking-[-0.32px]">
...
function ContainerText({ text }: ContainerTextProps) {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[28.5px] min-h-px min-w-px relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">{text}</p>
    </div>
  );
}
type TextProps = {
...
function Container7() {
  return (
    <Container6>
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[25.5px] min-h-px min-w-px relative shrink-0 text-[#151515] text-[15px] tracking-[-0.3px]">
...
function Container10() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Container">
      <Text text="운세 구성" additionalClassNames="justify-center" />
    </div>
  );
}
...
function Container11() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Container">
      <ContainerText text="앞으로 이 관계는 안정적으로 이어질까, 흔들리게 될까?" />
    </div>
  );
}
...
function Container14() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Container">
      <ContainerText text="의심과 불안을 줄이고 사랑을 지켜내려면 어떻게 해야 할까?" />
    </div>
  );
}
...
function Container17() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Container">
      <ContainerText text="지금 그의 마음은 나에게 머물고 있을까, 다른 곳을 향하고 있을까?" />
    </div>
  );
}
...
function ButtonContainer() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Button Container">
      <p className="font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[25px] relative shrink-0 text-[16px] text-nowrap text-white tracking-[-0.32px]">지금 풀이보러 가기</p>
    </div>
  );
}
