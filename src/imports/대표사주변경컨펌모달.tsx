import svgPaths from "./svg-gx8wouucjp";
...
function TextContainer() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-center justify-center min-h-px min-w-px relative shrink-0" data-name="Text Container">
      <p className="font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[25.5px] relative shrink-0 text-[18px] text-black tracking-[-0.36px] w-full">대표 사주를 변경하시겠어요?</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="대표 사주 변경 컨펌 모달">
