import svgPaths from "./svg-2u4joavd39";
import { imgGroup, imgGroup1, imgGroup2, imgGroup3 } from "./svg-pqo8i";
...
function GuidanceTooltip() {
  return (
    <div className="bg-[#48b2af] content-stretch flex flex-col gap-[4px] items-start px-[16px] py-[8px] relative rounded-[999px] shadow-[0px_2px_7px_0px_rgba(0,0,0,0.12)] shrink-0" data-name="Guidance / Tooltip">
      <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-nowrap text-white tracking-[-0.42px]">
        <p className="leading-[22px]">지금 시작하면 0원!</p>
      </div>
      <div className="absolute bottom-[-6px] flex h-[6px] items-center justify-center left-1/2 translate-x-[-50%] w-[20px]">
        <div className="flex-none rotate-[180deg]">
          <div className="h-[6px] relative w-[20px]" data-name="arrow">
            <div className="absolute inset-[5.54%_0_0_0]" style={{ "--fill-0": "rgba(72, 178, 175, 1)" } as React.CSSProperties}>
...
function Group() {
  return (
    <div className="[grid-area:1_/_1] h-[20.924px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[5.667px_5.669px] mask-size-[9.795px_9.586px] ml-[-57.86%] mt-[-59.14%] relative w-[21.133px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 21">
        <g id="Group">
          <path d={svgPaths.p21025780} fill="var(--fill-0, #3E82F1)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group1() {
  return (
    <div className="[grid-area:1_/_1] h-[19.602px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[5.669px] mask-size-[15.871px_8.265px] ml-[-35.72%] mt-[-68.59%] relative w-[27.209px]" data-name="Group" style={{ maskImage: `url('${imgGroup1}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 20">
        <g id="Group">
          <path d={svgPaths.p30d31f00} fill="var(--fill-0, #32A753)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ClipPathGroup1() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[5.43%] mt-[59.5%] place-items-start relative" data-name="Clip path group">
      <Group1 />
    </div>
  );
}
...
function Group3() {
  return (
    <div className="[grid-area:1_/_1] h-[19.602px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[5.669px] mask-size-[15.945px_8.265px] ml-[-35.55%] mt-[-68.59%] relative w-[27.282px]" data-name="Group" style={{ maskImage: `url('${imgGroup3}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 20">
        <g id="Group">
          <path d={svgPaths.p277c4e00} fill="var(--fill-0, #E74133)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ClipPathGroup3() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[5.43%] mt-0 place-items-start relative" data-name="Clip path group">
      <Group3 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col h-[697px] items-center justify-between relative shrink-0 w-full">
      <Frame />
      <Frame2 />
    </div>
  );
