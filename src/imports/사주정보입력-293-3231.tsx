import svgPaths from "./svg-egclegc7we";
...
type InputContainer4Props = {
  additionalClassNames?: string;
};

function InputContainer4({ children, additionalClassNames = "" }: React.PropsWithChildren<InputContainer4Props>) {
  return (
    <div className={clsx("bg-[#f8f8f8] relative shrink-0 w-full", additionalClassNames)}>
...
function ButtonContainer() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Button Container">
      <p className="font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[25px] relative shrink-0 text-[16px] text-nowrap text-white tracking-[-0.32px]">저장하기</p>
    </div>
  );
}
...
function InputContainer() {
  return (
    <InputContainer4 additionalClassNames="h-[56px] rounded-[16px]">
      <InputFieldText text="홍" />
    </InputContainer4>
  );
}
...
function InputContainer1() {
  return (
    <InputContainer4 additionalClassNames="h-[56px] rounded-[16px]">
      <InputFieldText text="1992-09-22" />
    </InputContainer4>
  );
}
...
function InputField() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Input Field">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#d4d4d4] text-[15px] tracking-[-0.45px]">예 21:00</p>
    </div>
  );
}
...
function InputContainer2() {
  return (
    <InputContainer4 additionalClassNames="h-[48px] rounded-[12px]">
      <InputField />
    </InputContainer4>
  );
}
...
function ButtonTextButton() {
  return (
    <div className="absolute content-stretch flex flex-col h-[34px] items-center justify-center left-[20px] px-[8px] py-0 rounded-[12px] top-[702px]" data-name="Button / Text Button">
      <Container1 />
    </div>
  );
}
...
function FormInput3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[20px] top-[563px] w-[350px]" data-name="Form / Input">
      <LabelContainerText text="휴대폰 번호(선택)" />
      <InputContainer3 />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="사주 정보 입력">
