import svgPaths from "./svg-qiqqy2txq9";
...
function InputContainer1({ children, text }: React.PropsWithChildren<InputContainer1Props>) {
  return (
    <div className="bg-white h-[56px] relative rounded-[16px] shrink-0 w-full">
      ...
      <Wrapper1>
        <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0">
          <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[15px] text-black tracking-[-0.45px]">{text}</p>
        </div>
      </Wrapper1>
    </div>
  );
...
function Wrapper({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] py-0 relative w-full">{children}</div>
      </div>
    </div>
  );
}
...
function FormInput1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[20px] top-[347px] w-[350px]" data-name="Form / Input">
      ...
      <InputContainer1 text="2026-09-99" />
      <ErrorContainer />
    </div>
  );
}
...
function FormInput3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[20px] top-[563px] w-[350px]" data-name="Form / Input">
      <LabelContainerText text="휴대폰 번호(풀이 완료 후 알림톡 발송에만 사용돼요)" />
      <InputContainer1 text="01122" />
      <ErrorContainer2 />
    </div>
  );
}
