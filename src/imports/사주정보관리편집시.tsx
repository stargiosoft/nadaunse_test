import svgPaths from "./svg-nykl32kbwr";
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[12px] relative w-full">{children}</div>
      </div>
    </div>
  );
}
...
function CardProfileCard2() {
  return (
    <div className="bg-[#f9f9f9] content-stretch flex gap-[11px] items-center px-[8px] py-[12px] relative rounded-[12px] shrink-0 w-[350px]" data-name="Card / ProfileCard">
      <ProfileContainer2 />
      <InfoContainer2 />
    </div>
  );
...
function Icons2() {
  return (
    <Wrapper>
      <path clipRule="evenodd" d={svgPaths.p1c4f0780} fill="var(--fill-0, #6D6D6D)" fillRule="evenodd" id="Vector" />
      <path d={svgPaths.p2b4bb800} fill="var(--fill-0, #6D6D6D)" id="Vector_2" />
    </Wrapper>
  );
}
...
function Button() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Button">
      <Icons2 />
      <p className="font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[25.5px] relative shrink-0 text-[#6d6d6d] text-[15px] text-nowrap tracking-[-0.3px]">정보 수정</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center pl-0 pr-[4px] py-0 relative shrink-0 w-[160px]" data-name="Container">
      <Container4 />
    </div>
  );
}
...
function Icons3() {
  return (
    <Wrapper>
      <path d={svgPaths.p89eb200} fill="var(--fill-0, #FA5B4A)" id="Vector" />
    </Wrapper>
  );
}
...
function Button1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Button">
      <Icons3 />
      <p className="font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[25.5px] relative shrink-0 text-[#fa5b4a] text-[15px] text-nowrap tracking-[-0.3px]">정보 삭제</p>
    </div>
  );
}
...
function ButtonCategoryPopupButtons() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[12px] items-center justify-center left-[210px] px-0 py-[16px] rounded-[16px] top-[493px]" data-name="Button / Category Popup Buttons">
      ...
      <div className="h-0 relative shrink-0 w-[160px]">
        <div className="absolute inset-[-0.5px_0]" style={{ "--stroke-0": "rgba(243, 243, 243, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 160 1">
            <path d="M0 0.5H160" id="Vector 57" stroke="var(--stroke-0, #F3F3F3)" />
          </svg>
        </div>
      </div>
      <Container7 />
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="사주 정보 관리 (편집 시)">
