import svgPaths from "./svg-zn91u2salz";
    ...
    <div className="h-[10px] relative shrink-0 w-[40px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 10">
        <g id="Frame 427321712">
          <circle cx="5" cy="5" fill="var(--fill-0, #E4F7F7)" id="Ellipse 1" r="5" />
          <circle cx="20" cy="5" fill="var(--fill-0, #7ED4D2)" id="Ellipse 3" r="5" />
          <circle cx="35" cy="5" fill="var(--fill-0, #48B2AF)" id="Ellipse 2" r="5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col font-['Pretendard_Variable:Bold',sans-serif] font-bold gap-[4px] items-start leading-[0] relative shrink-0 text-[22px] text-black text-center tracking-[-0.22px] w-full">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[32.5px]">홍길동님의</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
...
function HomeIndicatorContainer() {
  return (
    <div className="absolute bottom-[-907px] content-stretch flex flex-col items-start left-1/2 overflow-clip translate-x-[-50%] w-[390px]" data-name="Home Indicator Container">
      <HomeIndicatorLight />
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[11.336px] right-[14.67px] top-[17.33px] w-[66.662px]" data-name="Right Side">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 67 12">
        <g id="Right Side">
          <g id="Battery">
            <path d={svgPaths.pa1fe280} id="Rectangle" opacity="0.35" stroke="var(--stroke-0, black)" />
            <path d={svgPaths.p25868280} fill="var(--fill-0, black)" id="Combined Shape" opacity="0.4" />
            <path d={svgPaths.p18fdac00} fill="var(--fill-0, black)" id="Rectangle_2" />
          </g>
          <path d={svgPaths.p2450900} fill="var(--fill-0, black)" id="Wifi" />
          <path d={svgPaths.p15058c00} fill="var(--fill-0, black)" id="Mobile Signal" />
        </g>
      </svg>
    </div>
  );
...
function TopNavigationContainer() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-0" data-name="Top Navigation Container">
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="로딩중">
