import svgPaths from "./svg-e7v1e00rzc";
...
import img1 from "figma:asset/f494ca2b3b180a2d66b2960718e3e515db3248a2.png";
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center left-1/2 top-[247px] translate-x-[-50%] w-[360px]">
      <Frame />
      <div className="h-[114px] relative shadow-[4.855px_3.641px_12.137px_0px_rgba(0,0,0,0.05)] shrink-0 w-[68px]" data-name="타로 카드 1">
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="카드 뽑음">
      <Container25 />
