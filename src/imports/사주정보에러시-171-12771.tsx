import svgPaths from "./svg-4w6p1ztfvp";
...
function InputField() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Input Field">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[15px] text-black tracking-[-0.45px]">홍</p>
    </div>
  );
}
...
function InputContainer() {
  return (
    <div className="bg-[#f8f8f8] h-[56px] relative rounded-[16px] shrink-0 w-full" data-name="Input Container">
      <div className="flex flex-row items-center size-full">
...
function InputFieldContainer() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Input field container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[15px] text-black tracking-[-0.45px]">2026-09-99</p>
    </div>
  );
}
...
function ErrorMessageContainer() {
  return (
    <div className="basis-0 content-stretch flex gap-[4px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Error message container">
      <Icons />
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[22px] min-h-px min-w-px relative shrink-0 text-[#fa5b4a] text-[13px]">생년월일을 정확하게 입력해주세요.</p>
    </div>
  );
}
...
function InputFieldContainer1() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Input field container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[15px] text-black tracking-[-0.45px]">오전 12:99</p>
    </div>
  );
}
...
function InputContainer2() {
  return (
    <div className="bg-white h-[48px] relative rounded-[12px] shrink-0 w-full" data-name="Input container">
      <div aria-hidden="true" className="absolute border border-[#fa5b4a] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-0 relative size-full">
...
function ErrorMessageContainer1() {
  return (
    <div className="basis-0 content-stretch flex gap-[4px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Error message container">
      <Icons1 />
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[22px] min-h-px min-w-px relative shrink-0 text-[#fa5b4a] text-[13px]">태어난 시를 정확하게 입력해주세요.</p>
    </div>
  );
}

function ErrorContainer1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Error container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] py-0 relative w-full">
...
function InputFieldContainer2() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Input field container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[15px] text-black tracking-[-0.45px]">01122</p>
    </div>
  );
}
...
function ErrorMessageContainer2() {
  return (
    <div className="basis-0 content-stretch flex gap-[4px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Error message container">
      <Icons4 />
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] font-normal grow leading-[22px] min-h-px min-w-px relative shrink-0 text-[#fa5b4a] text-[13px]">휴대폰 번호를 다시 확인해 주세요.</p>
    </div>
  );
}

function ErrorContainer2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Error container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] py-0 relative w-full">
          <ErrorMessageContainer2 />
        </div>
      </div>
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="사주 정보 에러 시">
