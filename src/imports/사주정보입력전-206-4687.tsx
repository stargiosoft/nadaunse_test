import svgPaths from "./svg-5lgee9tja4";

function Container() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Container">
      <p className="font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[25px] relative shrink-0 text-[#b7b7b7] text-[16px] text-nowrap tracking-[-0.32px]">다음</p>
    </div>
  );
}
...
function CommonBottomButton() {
  return (
    <div className="absolute bottom-[31px] content-stretch flex flex-col items-start left-1/2 shadow-[0px_-8px_16px_0px_rgba(255,255,255,0.76)] translate-x-[-50%] w-[390px]" data-name="Common / Bottom Button">
      <Container1 />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Label Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] py-0 relative w-full">
          <p className="basis-0 font-['Pretendard_Variable:Medium',sans-serif] font-medium grow leading-[22px] min-h-px min-w-px relative shrink-0 text-[#868686] text-[13px]">이름</p>
        </div>
      </div>
    </div>
  );
...
function InputFieldContainer() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Input Field Container">
      <p className="basis-0 font-['Pretendard_Variable:Medium',sans-serif] font-medium grow leading-[25px] min-h-px min-w-px relative shrink-0 text-[#d4d4d4] text-[16px] tracking-[-0.32px]">예: 홍길동</p>
    </div>
  );
}
...
function Input() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] items-start left-[20px] top-[115px] w-[354px]" data-name="• Input">
      <LabelContainer />
      <InputContainer />
    </div>
  );
...
function LabelContainer1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] py-0 relative w-full">
          <p className="basis-0 font-['Pretendard_Variable:Medium',sans-serif] font-medium grow leading-[22px] min-h-px min-w-px relative shrink-0 text-[#868686] text-[13px]">생년월일 (양력 기준으로 입력해 주세요)</p>
        </div>
      </div>
    </div>
  );
...
function InputFieldContainer1() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Input Field Container">
      <p className="basis-0 font-['Pretendard_Variable:Medium',sans-serif] font-medium grow leading-[25px] min-h-px min-w-px relative shrink-0 text-[#d4d4d4] text-[16px] tracking-[-0.32px]">예: 1992-07-15 (양력)</p>
    </div>
  );
}
...
function Input1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] items-start left-[20px] top-[347px] w-[354px]" data-name="• Input">
      <LabelContainer1 />
      <InputContainer1 />
    </div>
  );
...
function LabelContainer2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] py-0 relative w-full">
          <p className="basis-0 font-['Pretendard_Variable:Medium',sans-serif] font-medium grow leading-[22px] min-h-px min-w-px relative shrink-0 text-[#868686] text-[13px]">태어난 시간</p>
        </div>
      </div>
    </div>
  );
...
function InputField() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Input field">
      <p className="basis-0 font-['Pretendard_Variable:Medium',sans-serif] font-medium grow leading-[25px] min-h-px min-w-px relative shrink-0 text-[#d4d4d4] text-[16px] tracking-[-0.32px]">예: 21:00</p>
    </div>
  );
}
...
function Input2() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[2px] grow items-start min-h-px min-w-px relative shrink-0" data-name="• Input">
      <LabelContainer2 />
      <InputContainer2 />
    </div>
  );
...
function CheckBox() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 size-[44px]" data-name="• Check Box">
      <Checkbox />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center pb-0 pt-[24px] px-0 relative shrink-0">
      <p className="font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#5f5f5f] text-[15px] text-nowrap tracking-[-0.3px]">모르겠어요</p>
      <CheckBox />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-start justify-end left-[20px] top-[459px] w-[354px]">
      <Input2 />
      <Frame2 />
    </div>
  );
...
function LabelContainer3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] py-0 relative w-full">
          <p className="basis-0 font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal grow leading-[16px] min-h-px min-w-px not-italic relative shrink-0 text-[#848484] text-[12px] tracking-[-0.24px]">성별</p>
        </div>
      </div>
    </div>
  );
...
function SelectionControlsSelectionGroup() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[20px] top-[227px] w-[354px]" data-name="Selection Controls / Selection Group">
      <LabelContainer3 />
      <OptionsContainer />
    </div>
  );
