import svgPaths from "./svg-qseau8dlei";
import clsx from "clsx";
import imgGeminiGeneratedImageE2Poh7E2Poh7E2Po4 from "figma:asset/5615ff21216f93eb47cac8ee15adee136174d7be.png";
...
function ContainerText({ text }: ContainerTextProps) {
  return (
    <Wrapper>
      <p className="basis-0 font-['Pretendard_Variable:Medium',sans-serif] font-medium grow leading-[23.5px] min-h-px min-w-px relative shrink-0 text-[15px] text-black tracking-[-0.3px]">{text}</p>
    </Wrapper>
  );
}
    ...
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[350px]" data-name="Container">
      <div className="h-[54px] pointer-events-none relative rounded-[12px] shrink-0 w-[80px]" data-name="Gemini_Generated_Image_e2poh7e2poh7e2po 4">
        <div className="absolute inset-0 overflow-hidden rounded-[12px]">
          <img alt="" className="absolute h-[124.5%] left-[-4.05%] max-w-none top-[-12.25%] w-[108.11%]" src={imgGeminiGeneratedImageE2Poh7E2Poh7E2Po4} />
        </div>
        <div aria-hidden="true" className="absolute border border-[#f9f9f9] border-solid inset-[-1px] rounded-[13px]" />
      </div>
      <Container />
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="상세 풀이">
      <Frame />
      <Frame1 />
      <Frame5 />
    </div>
