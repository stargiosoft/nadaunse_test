import svgPaths from "./svg-ewb1xczw0i";
...
function Item() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Item">
      <p className="font-['Pretendard_Variable:SemiBold',sans-serif] leading-[25.5px] not-italic relative shrink-0 text-[#151515] text-[15px] tracking-[-0.3px] w-full">[맛보기]</p>
    </div>
  );
}
...
function Item1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Item">
      <p className="font-['Pretendard_Variable:Regular',sans-serif] leading-[25.5px] not-italic relative shrink-0 text-[15px] text-neutral-600 tracking-[-0.3px] w-full">이 만남은 처음부터 비교적 온화하고 안정적인 기운 속에서 시작되었습니다. 일주(日柱)의 기운과 상대방의 사주가 크게 충돌하지 않아, 첫 만남에서부터 서로에게 편안한 기류가 흐르고, 자연스럽게 가까워질 수 있는 끌림이 있었습니다. 당시의 관계는 불필요한 긴장감이나 갈등보다는 부드럽고 평온한 흐름으로 이어졌습니다. 겉으로 드러나는 모습만 보아도 불안정하거나 삐걱거림이 적었</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#f9f9f9] h-[252px] relative rounded-[12px] shrink-0 w-full" data-name="Container">
      <div className="size-full">
        <div className="content-stretch flex h-[252px] items-start px-[20px] py-[16px] relative w-full">
          <Container4 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons">
          <path d={svgPaths.p21158a00} fill="var(--fill-0, #A0D2D1)" id="Vector" />
          <path d={svgPaths.p1662d200} fill="var(--fill-0, #48B2AF)" id="Vector_2" />
          <path d={svgPaths.p1c098700} fill="var(--fill-0, #8BD4D2)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function Container11() {
  return (
    <div className="absolute bottom-0 left-0 right-0 flex flex-col items-center" data-name="Container">
      {/* 그라데이션 페이드 효과 */}
      <div className="w-full h-[60px] bg-gradient-to-t from-[#f9f9f9] to-transparent" />
      {/* 하단 고정 영역 */}
      <div className="w-full bg-[#f9f9f9] p-[16px] flex items-center justify-center gap-[8px] rounded-bl-[16px] rounded-br-[16px]">
        <Icons />
        <p className="font-['Pretendard_Variable:Medium',sans-serif] leading-[22px] text-[#41a09e] text-[14px] tracking-[-0.42px]">
          여기까지만 공개돼요
        </p>
      </div>
    </div>
...
function CardAnswerPreviewCard() {
  return (
    <div className="h-[293px] relative shrink-0 w-[350px] overflow-hidden rounded-[12px]" data-name="Card / Answer Preview Card">
      <Container7 />
      <Container11 />
    </div>
  );
...
function Container22() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-center min-h-px min-w-px relative shrink-0" data-name="Container">
      <p className="basis-0 font-['Pretendard_Variable:SemiBold',sans-serif] grow leading-[28.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">03. 우리 관계, 지금이 전환점일까?</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center justify-center relative shrink-0 w-full" data-name="Container">
      <Swords11Png />
      <p className="font-['Pretendard_Variable:Regular',sans-serif] leading-[25.5px] min-w-full not-italic relative shrink-0 text-[15px] text-neutral-600 tracking-[-0.3px] w-[min-content]">이 카드는 호기심과 탐구심, 그리고 진실을 알고자 하는 열망을 상징합니다. 상대방을 향한 당신의 관심이 깊어지고 있으며, 마음속에 질문이 많아지는 시기일 수 있습니다. 다만, 모든 것을 성급히 판단하기보다 관찰하고 배워가야 할 때입니다. 말과 행동에서 솔직함이 중요하며, 작은 오해를 바로잡는 데 힘쓰면 관계가 훨씬 안정될 수 있습니다.</p>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="bg-[#f9f9f9] h-[400px] relative rounded-[12px] shrink-0 w-full" data-name="Container">
      <div className="size-full">
        <div className="content-stretch flex h-[400px] items-start px-[20px] py-[16px] relative w-full">
          <Container26 />
        </div>
      </div>
    </div>
...
function CardAnswerPreviewCard2() {
  return (
    <div className="h-[441px] relative shrink-0 w-[350px] overflow-hidden rounded-[12px]" data-name="Card / Answer Preview Card">
      <Container29 />
      <Container33 />
    </div>
  );
...
function Container35() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px pb-0 pt-[3px] px-0 relative shrink-0" data-name="Container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] grow leading-[28.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">04. 그 사람의 마음, 진심일까 순간일까?</p>
    </div>
  );
}
...
function Container36() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px pb-0 pt-[3px] px-0 relative shrink-0" data-name="Container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] grow leading-[28.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">05. 잠시 스치는 인연일까, 평생의 동반자일까?</p>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px pb-0 pt-[3px] px-0 relative shrink-0" data-name="Container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] grow leading-[28.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">06. 사랑이 흔들리는 순간, 끝일까 새로운 시작일까?</p>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px pb-0 pt-[3px] px-0 relative shrink-0" data-name="Container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] grow leading-[28.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">07. 내가 붙잡아야 할 사랑일까, 놓아야 할 인연일까?</p>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px pb-0 pt-[3px] px-0 relative shrink-0" data-name="Container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] grow leading-[28.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">08. 내가 붙잡아야 할 사랑일까, 놓아야 할 인연일까?</p>
    </div>
  );
}
...
function Container40() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px pb-0 pt-[3px] px-0 relative shrink-0" data-name="Container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] grow leading-[28.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">09. 그와 나, 운명처럼 이어질까?</p>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px pb-0 pt-[3px] px-0 relative shrink-0" data-name="Container">
      <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] grow leading-[28.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#151515] text-[16px] tracking-[-0.32px]">10. 우리의 사랑, 위기일까 기회일까?</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Container">
      <p className="font-['Pretendard_Variable:Medium',sans-serif] leading-[25.5px] not-italic relative shrink-0 text-[#41a09e] text-[15px] text-center tracking-[-0.3px] w-full">더 깊은 풀이는 구매 후 확인할 수 있습니다</p>
    </div>
  );
}
    ...
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[12px] shrink-0" data-name="Navigation / Tab Item">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[8px] relative w-full">
          <p className="font-['Pretendard_Variable:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#999999] text-[15px] text-nowrap tracking-[-0.45px] whitespace-pre">상품 설명</p>
        </div>
      </div>
    </div>
  );
...
function NavigationTabItem1() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[12px] shrink-0" data-name="Navigation / Tab Item">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[8px] relative w-full">
          <p className="font-['Pretendard_Variable:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#999999] text-[15px] text-nowrap tracking-[-0.45px] whitespace-pre">풀이 원리</p>
        </div>
      </div>
    </div>
  );
...
function NavigationTabItem2() {
  return (
    <div className="basis-0 bg-[#f8f8f8] grow min-h-px min-w-px relative rounded-[12px] shrink-0" data-name="Navigation / Tab Item">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[8px] relative w-full">
          <p className="font-['Pretendard_Variable:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#151515] text-[15px] text-nowrap tracking-[-0.45px] whitespace-pre">맛보기</p>
        </div>
      </div>
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="맛보기">
