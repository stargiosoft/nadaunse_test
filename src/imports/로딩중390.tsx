import svgPaths from "./svg-rj5zh7ifhy";

function DotLoading() {
  return (
    <div className="h-[10px] relative shrink-0 w-[40px]" data-name="Dot loading">
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="로딩중 _ 390">
