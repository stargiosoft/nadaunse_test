import svgPaths from "./svg-e5t3pv6g6z";
...
function CardInterpretationCard() {
  return (
    <div className="absolute bg-[#f9f9f9] content-stretch flex items-start justify-center left-1/2 px-[20px] py-[28px] rounded-[16px] top-[115px] translate-x-[-50%] w-[350px]" data-name="Card / Interpretation Card">
      <Container3 />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="타로 풀이 _ 390">
