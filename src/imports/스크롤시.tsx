import svgPaths from "./svg-vygi4z7kvc";
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] items-start left-0 top-[64px] w-[390px]">
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="스크롤 시">
      <Frame />
      <Frame1 />
      <Frame5 />
    </div>
