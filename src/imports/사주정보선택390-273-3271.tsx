import svgPaths from "./svg-d0rrojy5kr";
...
function CardProfileCard4({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[11px] items-center px-[8px] py-[12px] relative w-full">{children}</div>
      </div>
    </div>
  );
}
...
function DetailsContainer1() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] items-start relative shrink-0 w-full" data-name="Details Container">
      <BirthdateContainerText text="양력 1994.07.23 午(오)시" />
      <AttributesContainer text="개띠" text1="물고기자리" text2="여성" />
    </div>
  );
}
...
function DetailsContainer2() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] items-start relative shrink-0 w-full" data-name="Details Container">
      <BirthdateContainerText text="양력 1994.07.23 午(오)시" />
      <AttributesContainer text="양띠" text1="물고기자리" text2="여성" />
    </div>
  );
}
...
function DetailsContainer3() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] items-start relative shrink-0 w-full" data-name="Details Container">
      <BirthdateContainerText text="양력 1994.07.23 午(오)시" />
      <AttributesContainer text="토끼띠" text1="물고기자리" text2="여성" />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="사주 정보 선택 _ 390">
