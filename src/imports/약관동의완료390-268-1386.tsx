import svgPaths from "./svg-4rv99s3u2l";
...
function ImageContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[46px] items-center justify-center left-[20px] top-[calc(50%+0.5px)] translate-y-[-50%] w-[350px]" data-name="Image Container">
      <Frame />
      <TextComponent />
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="약관 동의 완료 _ 390">
      <ButtonSquareButton />
      <CommonBottomButton />
      <ImageContainer />
