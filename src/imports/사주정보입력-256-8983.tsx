import svgPaths from "./svg-vaz9l1c4ol";
...
type InputContainer3Props = {
  additionalClassNames?: string;
};

function InputContainer3({ children, additionalClassNames = "" }: React.PropsWithChildren<InputContainer3Props>) {
  return (
...
function InputContainer() {
  return (
    <InputContainer3 additionalClassNames="h-[56px] rounded-[16px]">
      <InputFieldText text="기존에 입력한 이름" />
    </InputContainer3>
  );
}
...
function InputContainer2() {
  return (
    <InputContainer3 additionalClassNames="h-[48px] rounded-[12px]">
      <InputField />
    </InputContainer3>
  );
}
