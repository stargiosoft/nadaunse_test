...
/hooks/useRequireAuth.ts        → 로그인 필수 페이지 훅
...
/components/skeletons/          → 로딩 스켈레톤 UI
...
/components/MasterContentDetailPage.tsx → 유료 콘텐츠 상세
...
```
/supabase/functions/generate-free-preview/        → 무료 미리보기 생성
...
/supabase/functions/send-alimtalk/                → 알림톡 발송
```
...
- `/components/FreeSajuDetail.tsx` - 결과 페이지

**Edge Function**: `/generate-free-preview`
...
**Edge Function**: `/generate-master-content`
